...
- Car Rental System (C# / .NET 8)  
  Console-based OOP application demonstrating business logic and object-oriented design.

- EduConnect Backend (academic – private)  
  REST API project using MVC architecture and PostgreSQL integration.
